...
for xd in range(10000):
	...
	c=' RMX1941 Build/PPR1.180610.011; wv'
	...
	l='Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/307.0.0.9.109;]'
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"user-agent":"Mozilla/5.0 (Linux; Android 10; moto e (XT2052DL) Build/QPGS30.82-141-15-2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/375.1.0.28.111;]"}
				if 'no' in taplikasi:
					ok+=1
